    ...
    <el-main class="sa-p-0">
      <el-container>
        ...
        <el-main class="app-layout__right sa-p-0">
          <div v-if="appLayout.showTaskbar" class="app-layout__taskbar flex justify-between">
            <collapse-btn />
...
<script setup>
  ...
  import SaModal from '@/spring/components/sa-modal/sa-modal.vue';
  import SaFileModal from '@/spring/components/sa-file/sa-file-modal.vue';
  import SaDrawer from '@/spring/components/sa-drawer/sa-drawer.vue';
  import SpGlobalModal from '@/spring/components/sp-global-modal/index.vue';
  import SpCommonSearch from '@/spring/components/sp-common-search/index.vue';
  ...
  import SaSvg from '@/spring/components/sa-icon/sa-svg.global.vue';
  import LanguageBtn from '@/spring/layouts/component/language-btn/index.vue';
