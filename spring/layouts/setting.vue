<template>
      ...
      <div class="setting-item__wrap">
        ...
        <div class="contant sa-flex sa-flex-wrap">
          ...
          >
            <div
              class="theme-image"
              :class="item.name == appLayout.theme ? 'active' : ''"
            >
              <img
                v-if="item.name == 'sheep'"
                src="/static/images/theme/sheep.png"
              />
              <img
                v-if="item.name == 'element'"
                src="/static/images/theme/element.png"
              />
              <img
                v-if="item.name == 'classical'"
                src="/static/images/theme/classical.png"
              />
            </div>
            <div class="name">
              {{
  ...
  <div class="setting-footer">
    ...
    <div class="setting-footer__bottom">
      Copyright © Spring admin All Rights Reserved.
    </div>
  </div>
</template>
...
import { setTheme, setDarkMode } from "@/hooks/useTheme";
