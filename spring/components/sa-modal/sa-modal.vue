  ...
  >
    ...
    <template #header>
      ...
      <div class="tools-wrap sa-flex">
        ...
        <!--        </div>-->
        <div v-if="!isMobile()" class="sa-flex sa-row-center sa-m-l-8" @click="fullscreen(index)">
    ...
    <component :is="modal.component" :modal="modal" @modalCallBack="modalCallBack(index, $event)" />
  </el-dialog>
...
<script setup>
  ...
  import { buildShortUUID, isMobile } from '@/spring/utils';
